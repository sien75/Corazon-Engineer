...
Expected: 200, `{ "op": "add", "type": "atom", "id": "atoms/added-service.yaml", "file": "atoms/added-service.yaml" }`, and the file `.corazon/.playground/atoms/added-service.yaml` is written (top-level `atoms:` list).
