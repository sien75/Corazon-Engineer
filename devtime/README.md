...
2. **Design records** — important decisions and risks go into `architecture/iteration-XXXX/` (one dir per iteration number); do not leave them scattered in chat.
3. **Deploy** — launch local services per `deploy/dev/BOOK.md` (log :7503 → static :7502 → ai :7501 → web :7500).
